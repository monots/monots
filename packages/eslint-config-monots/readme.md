...
You can always add your own rules and disable any rules you don't like by adding a rules property to
the configuration.
...
This config is primarily for use within a monots repo. At the moment it is very strict and aims to
allow multiple people working on a project to all conform to the same standard.
