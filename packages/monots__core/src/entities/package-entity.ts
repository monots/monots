...
import type { EntrypointField, ExportsField, PackageMonots } from '../schema.js';
import { Entrypoint, Package } from '../schema.js';
...
export class PackageEntity extends BaseEntity<Package> {
  ...
  get fields(): EntrypointField[] {
    return (this.#fields ??= objectKeys(Entrypoint.schema).filter(
