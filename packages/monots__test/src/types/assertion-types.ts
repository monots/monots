...
export interface ThrowsAssertion {
   ...
   */
  <ThrownError extends Error>(fn: () => any, expectations?: ThrowsExpectation, message?: string):
    | ThrownError
    | undefined;
...
export interface ThrowsAsyncAssertion {
   ...
   */
  <ThrownError extends Error>(
    fn: () => PromiseLike<any>,
    expectations?: ThrowsExpectation,
    message?: string,
  ): Promise<ThrownError | undefined>;
  ...
  <ThrownError extends Error>(
    ...
    expectations?: ThrowsExpectation,
    message?: string,
  ): Promise<ThrownError | undefined>; // eslint-disable-line @typescript-eslint/unified-signatures
