...
import { logMock, modifyPkg, getPkg, testdir, js, repoNodeModules } from '../../test-utils';
...
test('one-entrypoint-with-browser-field-one-without', async () => {
  let tmpPath = await testdir({
    ...
    'multiply/package.json': JSON.stringify({
      main: 'dist/one-entrypoint-with-browser-field-one-without-multiply.cjs.js',
      module: 'dist/one-entrypoint-with-browser-field-one-without-multiply.esm.js',
      browser: {
...
test('monorepo umd with dep on other module incorrect peerDeps', async () => {
  let tmpPath = await testdir({
    ...
    'packages/package-four/package.json': JSON.stringify({
      ...
      main: 'dist/some-scope-incorrect-peerdeps-package-four-umd-with-dep.cjs.js',
      'umd:main': 'dist/some-scope-incorrect-peerdeps-package-four-umd-with-dep.umd.min.js',
    ...
    'packages/package-one/package.json': JSON.stringify({
      ...
      main: 'dist/some-scope-incorrect-peerdeps-package-one-umd-with-dep.cjs.js',
      'umd:main': 'dist/some-scope-incorrect-peerdeps-package-one-umd-with-dep.umd.min.js',
    ...
    'packages/package-three/package.json': JSON.stringify({
      ...
      main: 'dist/some-scope-incorrect-peerdeps-package-three-umd-with-dep.cjs.js',
      'umd:main': 'dist/some-scope-incorrect-peerdeps-package-three-umd-with-dep.umd.min.js',
    ...
    'packages/package-two/package.json': JSON.stringify({
      ...
      main: 'dist/some-scope-incorrect-peerdeps-package-two-umd-with-dep.cjs.js',
      'umd:main': 'dist/some-scope-incorrect-peerdeps-package-two-umd-with-dep.umd.min.js',
