<p align="center">
  <a href="#">
    <img width="300" height="300" src="../support/assets/logo.svg" alt="svg logo from openmoji.org" title="SVG Logo from openmoji.org" />
  </a>
</p>
...
This codebase is under heavy development and is not yet ready for anything other than experimental contexts.
...
**API docs**: Using `@microsft/api-extractor` monots is able to automatically build documentation for all your packages conforming to the `tsdoc` standard. This means that markdown files for your documentation can be consumed
