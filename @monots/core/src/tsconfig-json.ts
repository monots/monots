export namespace TsConfigJson {
  ...
  export interface CompilerOptions {
     ...
     * 'UMD', 'ES6', 'ES2015' or 'ESNext'. Only 'AMD' and 'System' can be used
     * in conjunction with --outFile. 'ES6' and 'ES2015' values may be used when
    ...
    /**
     * Skip type checking of declaration files. Requires TypeScript version 2.0
     * or later.
     *
     * @default false
     */
    ...
    /**
     * Keep outdated console output in watch mode instead of clearing the
     * screen.
     *
     * @default false
     */
     ...
     *
     * @default true (unless piping to another program or redirecting output to
     * a file)
     */
    pretty?: boolean;
    ...
    /**
     * Enable to list all emitted files. Requires TypeScript version 2.0 or
     * later.
     *
     * @default false
     */
    ...
    /**
     * Disable size limit for JavaScript project. Requires TypeScript version
     * 2.0 or later.
     *
     * @default false
     */
    ...
    /**
     * List of library files to be included in the compilation. Requires
     * TypeScript version 2.0 or later.
     */
     ...
     * e.g. 'React.createElement' or 'h'. Requires TypeScript version 2.1 or
     * later.
     *
    ...
    /**
     * Enable all strict type checking options. Requires TypeScript version 2.3
     * or later.
     *
     * @default false
     */
  ...
  export interface References {
     ...
     * this project. Only valid for --outFile compilations.
     */
    prepend?: boolean;
