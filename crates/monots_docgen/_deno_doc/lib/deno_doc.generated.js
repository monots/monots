...
const heap = Array.from({ length: 32 }).fill();
...
function __wbg_adapter_16(arg0, arg1, arg2) {
  wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hae90311915cc92e3(
    arg0,
    arg1,
    addHeapObject(arg2),
  );
...
function handleError(f, args) {
  try {
    ...
    wasm.__wbindgen_exn_store(addHeapObject(error));
  }
}
...
switch (wasm_url.protocol) {
  ...
  case 'http:': {
    ...
    wasmInstantiatePromise = wasmResponse.headers
      .get('content-type')
      ?.toLowerCase()
      .startsWith('application/wasm')
      ? WebAssembly.instantiateStreaming(wasmResponse, imports)
      : WebAssembly.instantiate(await wasmResponse.arrayBuffer(), imports);
